...
# GBiehl, 08.12.2020, Completed all sections with "Add Code here
# GBiehl, 08.13.2020, Added the express menu and capitalization/spelling robustness to Option 2
#                     Still puzzled by line 60 for loop only removing first task of duplicate
# GBiehl, 08.13.2020, Updated remove_data_from_list function with code from Dr. Root
# ---------------------------------------------------------------------------- #
